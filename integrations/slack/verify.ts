/**
 * Slack signs every request when the app has a signing secret. Moved from
 * `apps/worker/src/services/slack/verify.ts` unchanged: the bytes it hashes
 * are the raw body, so whatever hands it a request has to have kept them.
 */
