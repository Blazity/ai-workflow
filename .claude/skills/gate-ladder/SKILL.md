...
Read the [current gate list](../../../docs/architecture/gates.md) and the [required CI rules](../../../docs/adr/ADR-004-gates-and-required-ci.md) before deciding which checks are required.
