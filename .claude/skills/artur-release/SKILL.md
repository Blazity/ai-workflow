...
- **"Release-note pull request has no approved review"**: the notes PR was merged without a formal Approve. Recovery: delete the notes file from main in one commit, re-add it in a NEW bot-authored PR, approve, merge (this happened for 2026.08.0; PRs #196->#198).
