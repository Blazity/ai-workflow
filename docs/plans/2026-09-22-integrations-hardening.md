...
### D12. A provider id is an integration id, on every path (round H2)
...
### D13. A cancel names the claim it holds; a reconcile pass reads its tracker once (round H2)
...
### D14. Tracing never fails a run, and one function keeps that promise (round H2)
...
<!-- ledger:start -->
Totals: 169 findings; FIXED 109, OPEN 52, DEFERRED 8.
