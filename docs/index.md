...
| [plans/2026-09-23-memory-package-ux.md](./plans/2026-09-23-memory-package-ux.md) | Draft: the UX spec for agent memory (run page Memory card, `/memory` store panel, history, search, forget and copy, Mem0 disable preview, MCP answer shapes, one vocabulary) and what stage 9 must prove |
