...
| [ADR-006](./ADR-006-model-catalog.md) | Model catalog | Superseded by ADR-011 | Written |
...
| [ADR-011](./ADR-011-harness-profiles-pick-from-the-capability-catalog.md) | Harness profiles pick from the capability catalog | Accepted | Written |
