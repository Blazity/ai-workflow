...
| `PRE_PR_CHECKS`                               | unset                                                                                                                                                       | Optional JSON config for explicit per-repo sandbox checks before branch push / PR creation, for example `{"repositories":[{"provider":"github","repoPath":"owner/repo","commands":["pnpm typecheck","pnpm test"]}]}` |
