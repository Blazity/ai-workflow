...
import { t as require_dist$2 } from "../slack__logger.mjs";
import { t as require_dist$3 } from "../slack__types.mjs";
...
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/dist/errors.js
var require_errors = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	function requestErrorWithOriginal(original, attachOriginal) {
		const error = errorWithCode(/* @__PURE__ */ new Error(`A request error occurred: ${original.message}`), ErrorCode.RequestError);
		if (attachOriginal) error.original = original;
		return error;
	}
	/**
	...
	*/
	function httpErrorFromResponse(response) {
		const error = errorWithCode(/* @__PURE__ */ new Error(`An HTTP protocol error occurred: statusCode = ${response.status}`), ErrorCode.HTTPError);
		error.statusCode = response.status;
		error.statusMessage = response.statusText;
		const nonNullHeaders = {};
		for (const k of Object.keys(response.headers)) if (k && response.headers[k]) nonNullHeaders[k] = response.headers[k];
	...
	*/
	function platformErrorFromResult(result) {
		const error = errorWithCode(/* @__PURE__ */ new Error(`An API error occurred: ${result.error}`), ErrorCode.PlatformError);
		error.data = result;
		return error;
	}
	/**
	...
	*/
	function rateLimitedErrorWithDelay(retrySec) {
		const error = errorWithCode(/* @__PURE__ */ new Error(`A rate-limit has been reached, you may retry this request in ${retrySec} seconds`), ErrorCode.RateLimitedError);
		error.retryAfter = retrySec;
		return error;
	}
}));
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/package.json
...
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/dist/instrument.js
var require_instrument = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const os = __importStar(__require("node:os"));
	const node_path_1$1 = __require("node:path");
	...
	*/
	...
	const baseUserAgent = `${replaceSlashes(packageJson.name)}/${packageJson.version} ${(0, node_path_1$1.basename)(process.title)}/${process.version.replace("v", "")} ${os.platform()}/${os.release()}`;
	const appMetadata = {};
	/**
...
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/dist/logger.js
var require_logger = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.LogLevel = void 0;
	exports.getLogger = getLogger;
	const logger_1 = require_dist$2();
	var logger_2 = require_dist$2();
...
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/dist/retry-policies.js
var require_retry_policies = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/dist/types/request/index.js
var require_request = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/dist/types/response/index.js
var require_response = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
}));
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/dist/chat-stream.js
var require_chat_stream = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var ChatStreamer = class {
		...
		*/
		constructor(client, logger, args, options) {
			...
			this.client = client;
			this.logger = logger;
			this.options = { buffer_size: (_a = options.buffer_size) !== null && _a !== void 0 ? _a : 256 };
			this.state = "starting";
		...
		*/
		async append(args) {
			if (this.state === "completed") throw new Error(`failed to append stream: stream state is ${this.state}`);
			const { markdown_text, chunks } = args, opts = __rest(args, ["markdown_text", "chunks"]);
			if (opts.token) this.token = opts.token;
			if (markdown_text) this.buffer += markdown_text;
			if (this.buffer.length >= this.options.buffer_size || chunks) return await this.flushBuffer(Object.assign({ chunks }, opts));
			const details = {
		...
		*/
		async stop(args) {
			if (this.state === "completed") throw new Error(`failed to stop stream: stream state is ${this.state}`);
			...
			if (!this.streamTs) {
				...
				if (!response.ts) throw new Error("failed to stop stream: stream not started");
				this.streamTs = response.ts;
				this.state = "in_progress";
			}
			const chunksToFlush = [];
			if (this.buffer.length > 0) chunksToFlush.push({
				type: "markdown_text",
				text: this.buffer
			});
			if (chunks) chunksToFlush.push(...chunks);
			const response = await this.client.chat.stopStream(Object.assign({
				token: this.token,
				channel: this.streamArgs.channel,
				ts: this.streamTs,
		...
		async flushBuffer(args) {
			...
			if (chunks) chunksToFlush.push(...chunks);
			if (!this.streamTs) {
				const response = await this.client.chat.startStream(Object.assign(Object.assign(Object.assign({}, this.streamArgs), {
					token: this.token,
					chunks: chunksToFlush
				}), opts));
				this.buffer = "";
			...
			const response = await this.client.chat.appendStream(Object.assign({
				token: this.token,
				channel: this.streamArgs.channel,
				ts: this.streamTs,
				chunks: chunksToFlush
...
//#endregion
//#region ../../node_modules/.pnpm/form-data@4.0.5/node_modules/form-data/lib/form_data.js
...
var require_follow_redirects = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function wrap(protocols) {
		...
		Object.keys(protocols).forEach(function(scheme) {
			...
			var wrappedProtocol = exports$3[scheme] = Object.create(nativeProtocol);
			function request(input, options, callback) {
				...
				options = Object.assign({
					maxRedirects: exports$3.maxRedirects,
					maxBodyLength: exports$3.maxBodyLength
				}, input, options);
...
//#endregion
//#region ../../node_modules/.pnpm/is-electron@2.2.2/node_modules/is-electron/index.js
...
var require_eventemitter3$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
var require_dist$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	const EventEmitter = require_eventemitter3$1();
...
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/dist/file-upload.js
var require_file_upload = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	async function getFileUploadJob(options, logger) {
		...
		if ("thread_ts" in options) fileUploadJob.thread_ts = options.thread_ts;
		if ("token" in options) fileUploadJob.token = options.token;
		if ("content" in options) return Object.assign({ content: options.content }, fileUploadJob);
		if ("file" in options) return Object.assign({ file: options.file }, fileUploadJob);
		throw (0, errors_1.errorWithCode)(/* @__PURE__ */ new Error("Either a file or content field is required for valid file upload. You must supply one"), errors_1.ErrorCode.FileUploadInvalidArgumentsError);
	}
	/**
	...
	*/
	async function getMultipleFileUploadJobs(options, logger) {
		if ("file_uploads" in options) return Promise.all(options.file_uploads.map((upload) => {
			const { blocks, channel_id, channels, initial_comment, thread_ts } = upload;
			if (blocks || channel_id || channels || initial_comment || thread_ts) throw (0, errors_1.errorWithCode)(new Error(buildInvalidFilesUploadParamError()), errors_1.ErrorCode.FileUploadInvalidArgumentsError);
			const uploadJobArgs = Object.assign(Object.assign({}, upload), {
				blocks: options.blocks,
				channels: options.channels,
				channel_id: options.channel_id,
				initial_comment: options.initial_comment
			});
			if ("thread_ts" in options) uploadJobArgs.thread_ts = options.thread_ts;
			if ("token" in options) uploadJobArgs.token = options.token;
			if ("content" in upload) return getFileUploadJob(Object.assign({ content: upload.content }, uploadJobArgs), logger);
			if ("file" in upload) return getFileUploadJob(Object.assign({ file: upload.file }, uploadJobArgs), logger);
			throw (0, errors_1.errorWithCode)(/* @__PURE__ */ new Error("Either a file or content field is required for valid file upload. You must supply one"), errors_1.ErrorCode.FileUploadInvalidArgumentsError);
		}));
	...
	async function getFileData(options) {
		...
		if ("file" in options) {
			...
			if (typeof file === "string") try {
				return (0, node_fs_1.readFileSync)(file);
			} catch (_err) {
				throw (0, errors_1.errorWithCode)(/* @__PURE__ */ new Error(`Unable to resolve file data for ${file}. Please supply a filepath string, or binary data Buffer or String directly.`), errors_1.ErrorCode.FileUploadInvalidArgumentsError);
			}
			const data = await getFileDataAsStream(file);
			if (data) return data;
		}
		if ("content" in options) return Buffer.from(options.content);
		throw (0, errors_1.errorWithCode)(/* @__PURE__ */ new Error("There was an issue getting the file data for the file or content supplied"), errors_1.ErrorCode.FileUploadReadFileDataError);
	}
	function getFileDataLength(data) {
		if (data) return Buffer.byteLength(data, "utf8");
	...
	async function getFileDataAsStream(readable) {
		...
		return new Promise((resolve, reject) => {
			...
			readable.on("end", () => {
				...
				else reject(Error("No data in supplied file"));
			});
		});
	}
	/**
		...
		for (const upload of fileUploads) {
			...
			if (file_id) {
				...
				if (!Object.prototype.hasOwnProperty.call(toComplete, compareString)) {
					...
					if ("token" in upload) toComplete[compareString].token = upload.token;
				} else toComplete[compareString].files.push({
					id: file_id,
					title
				});
			} else throw new Error(buildMissingFileIdError());
		}
		return toComplete;
	}
	/**
	...
	*/
	function warnIfNotUsingFilesUploadV2(method, logger) {
		const isTargetMethod = ["files.upload"].includes(method);
	...
	*/
	function errorIfChannelsCsv(options) {
		if ((options.channels ? options.channels.split(",") : []).length > 1) throw (0, errors_1.errorWithCode)(new Error(buildMultipleChannelsErrorMsg()), errors_1.ErrorCode.FileUploadInvalidArgumentsError);
	}
	/**
	...
	*/
	function errorIfInvalidOrMissingFileData(options) {
		...
		if (!(hasFile || hasContent) || hasFile && hasContent) throw (0, errors_1.errorWithCode)(/* @__PURE__ */ new Error("Either a file or content field is required for valid file upload. You cannot supply both"), errors_1.ErrorCode.FileUploadInvalidArgumentsError);
		if ("file" in options) {
			const { file } = options;
			if (file && !(typeof file === "string" || Buffer.isBuffer(file) || file instanceof node_stream_1.Readable)) throw (0, errors_1.errorWithCode)(/* @__PURE__ */ new Error("file must be a valid string path, buffer or Readable"), errors_1.ErrorCode.FileUploadInvalidArgumentsError);
		}
		if ("content" in options && options.content && typeof options.content !== "string") throw (0, errors_1.errorWithCode)(/* @__PURE__ */ new Error("content must be a string"), errors_1.ErrorCode.FileUploadInvalidArgumentsError);
	}
	/**
	* @param options
	* @param logger
	...
	*/
	function warnIfMissingOrInvalidFileNameAndDefault(options, logger) {
		var _a;
		const DEFAULT_FILENAME = `file.${(_a = options.filetype) !== null && _a !== void 0 ? _a : "txt"}`;
		const { filename } = options;
		if (!filename) {
			logger.warn(buildMissingFileNameWarning());
			return DEFAULT_FILENAME;
		}
		if (filename.split(".").length < 2) logger.warn(buildMissingExtensionWarning(filename));
		return filename;
	}
	/**
	...
	*/
	function warnIfLegacyFileType(options, logger) {
		if (options.filetype) logger.warn(buildLegacyFileTypeWarning());
	}
...
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/dist/helpers.js
...
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/dist/methods.js
var require_methods = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const WebClient_1 = require_WebClient();
	/**
	...
	*/
	var Methods = class extends eventemitter3_1.EventEmitter {
		constructor() {
			super();
			this.admin = {
				analytics: { getFile: bindApiCall(this, "admin.analytics.getFile") },
				apps: {
					activities: { list: bindApiCallWithOptionalArgument(this, "admin.apps.activities.list") },
					approve: bindApiCall(this, "admin.apps.approve"),
					approved: { list: bindApiCall(this, "admin.apps.approved.list") },
					...
					restricted: { list: bindApiCall(this, "admin.apps.restricted.list") },
				...
				conversations: {
					...
					ekm: { listOriginalConnectedChannelInfo: bindApiCallWithOptionalArgument(this, "admin.conversations.ekm.listOriginalConnectedChannelInfo") },
				...
				inviteRequests: {
					...
					approved: { list: bindApiCall(this, "admin.inviteRequests.approved.list") },
					denied: { list: bindApiCall(this, "admin.inviteRequests.denied.list") },
				...
				teams: {
					admins: { list: bindApiCall(this, "admin.teams.admins.list") },
					create: bindApiCall(this, "admin.teams.create"),
					list: bindApiCallWithOptionalArgument(this, "admin.teams.list"),
					owners: { list: bindApiCall(this, "admin.teams.owners.list") },
					settings: {
				...
				users: {
					...
					unsupportedVersions: { export: bindApiCall(this, "admin.users.unsupportedVersions.export") }
				},
				workflows: {
					collaborators: {
					...
					permissions: { lookup: bindApiCall(this, "admin.workflows.permissions.lookup") },
					search: bindApiCallWithOptionalArgument(this, "admin.workflows.search"),
					unpublish: bindApiCall(this, "admin.workflows.unpublish")
				}
			};
			this.api = { test: bindApiCallWithOptionalArgument(this, "api.test") };
			...
			this.apps = {
				connections: { open: bindApiCallWithOptionalArgument(this, "apps.connections.open") },
				event: { authorizations: { list: bindApiCall(this, "apps.event.authorizations.list") } },
				manifest: {
				...
				user: { connection: { update: bindApiCall(this, "apps.user.connection.update") } }
			};
			this.auth = {
				revoke: bindApiCallWithOptionalArgument(this, "auth.revoke"),
				teams: { list: bindApiCallWithOptionalArgument(this, "auth.teams.list") },
			...
			this.bots = { info: bindApiCallWithOptionalArgument(this, "bots.info") };
			this.calls = {
			...
			this.canvases = {
				...
				sections: { lookup: bindApiCall(this, "canvases.sections.lookup") }
			};
			this.chat = {
				...
				scheduledMessages: { list: bindApiCallWithOptionalArgument(this, "chat.scheduledMessages.list") },
			...
			this.conversations = {
				...
				canvases: { create: bindApiCall(this, "conversations.canvases.create") },
				...
				externalInvitePermissions: { set: bindApiCall(this, "conversations.externalInvitePermissions.set") },
			...
			this.dialog = { open: bindApiCall(this, "dialog.open") };
			this.dnd = {
			...
			this.emoji = { list: bindApiCallWithOptionalArgument(this, "emoji.list") };
			this.entity = { presentDetails: bindApiCall(this, "entity.presentDetails") };
			this.files = {
				...
				comments: { delete: bindApiCall(this, "files.comments.delete") },
				remote: {
			...
			this.migration = { exchange: bindApiCall(this, "migration.exchange") };
			this.oauth = {
			...
			this.team = {
				...
				billing: { info: bindApiCall(this, "team.billing.info") },
				externalTeams: {
				...
				preferences: { list: bindApiCallWithOptionalArgument(this, "team.preferences.list") },
				profile: { get: bindApiCallWithOptionalArgument(this, "team.profile.get") }
			};
			this.tooling = { tokens: { rotate: bindApiCall(this, "tooling.tokens.rotate") } };
			this.usergroups = {
			...
			this.users = {
				...
				discoverableContacts: { lookup: bindApiCall(this, "users.discoverableContacts.lookup") },
			...
			if (new.target !== WebClient_1.WebClient && !(new.target.prototype instanceof WebClient_1.WebClient)) throw new Error("Attempt to inherit from WebClient methods without inheriting from WebClient");
		}
	};
	exports.Methods = Methods;
	__exportStar(require_dist$3(), exports);
}));
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/dist/WebClient.js
var require_WebClient = /* @__PURE__ */ __commonJSMin(((exports) => {
	var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
		if (k2 === void 0) k2 = k;
		var desc = Object.getOwnPropertyDescriptor(m, k);
		if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) desc = {
	...
	const node_querystring_1 = __require("node:querystring");
	const node_util_1 = __require("node:util");
	const node_zlib_1 = __importDefault(__require("node:zlib"));
	const axios_1 = __importDefault(require_axios());
	const form_data_1 = __importDefault(require_form_data());
	const is_electron_1 = __importDefault(require_is_electron());
	const is_stream_1 = __importDefault(require_is_stream());
	const p_queue_1 = __importDefault(require_dist$1());
	const p_retry_1 = __importStar(require_p_retry());
	const chat_stream_1 = require_chat_stream();
	const errors_1 = require_errors();
	const file_upload_1 = require_file_upload();
	const helpers_1 = __importDefault(require_helpers());
	const instrument_1 = require_instrument();
	const logger_1 = require_logger();
	const methods_1 = require_methods();
	const retry_policies_1 = require_retry_policies();
	...
	*/
	var WebClient = class WebClient extends methods_1.Methods {
		/**
		...
		*/
		constructor(token, { slackApiUrl = "https://slack.com/api/", logger = void 0, logLevel = void 0, maxRequestConcurrency = 100, retryConfig = retry_policies_1.tenRetriesInAboutThirtyMinutes, agent = void 0, tls = void 0, timeout = 0, rejectRateLimitedCalls = false, headers = {}, teamId = void 0, allowAbsoluteUrls = true, attachOriginalToWebAPIRequestError = true, requestInterceptor = void 0, adapter = void 0 } = {}) {
			...
			if (!this.slackApiUrl.endsWith("/")) this.slackApiUrl += "/";
			...
			if (typeof logger !== "undefined") {
				this.logger = logger;
				if (typeof logLevel !== "undefined") this.logger.debug("The logLevel given to WebClient was ignored as you also gave logger");
			} else this.logger = (0, logger_1.getLogger)(WebClient.loggerName, logLevel !== null && logLevel !== void 0 ? logLevel : logger_1.LogLevel.INFO, logger);
			...
			if (requestInterceptor) this.axios.interceptors.request.use(requestInterceptor, null);
		...
		*/
		async apiCall(method, options = {}) {
			...
			if (result.response_metadata !== void 0 && result.response_metadata.warnings !== void 0) result.response_metadata.warnings.forEach(this.logger.warn.bind(this.logger));
			if (result.response_metadata !== void 0 && result.response_metadata.messages !== void 0) for (const msg of result.response_metadata.messages) {
				const errReg = /\[ERROR\](.*)/;
				const warnReg = /\[WARN\](.*)/;
				if (errReg.test(msg)) {
					const errMatch = msg.match(errReg);
					if (errMatch != null) this.logger.error(errMatch[1].trim());
				} else if (warnReg.test(msg)) {
					const warnMatch = msg.match(warnReg);
					if (warnMatch != null) this.logger.warn(warnMatch[1].trim());
				}
			}
			if (!result.ok && response.headers["content-type"] !== "application/gzip") throw (0, errors_1.platformErrorFromResult)(result);
			if ("ok" in result && result.ok === false) throw (0, errors_1.platformErrorFromResult)(result);
		...
		paginate(method, options, shouldStop, reduce) {
			...
			function generatePages() {
				return __asyncGenerator(this, arguments, function* generatePages_1() {
					let result;
					let paginationOptions = { limit: pageSize };
					if (options !== void 0 && options.cursor !== void 0) paginationOptions.cursor = options.cursor;
			...
			return (async () => {
				...
				try {
					for (var _d = true, pageIterator_1 = __asyncValues(pageIterator), pageIterator_1_1; pageIterator_1_1 = await pageIterator_1.next(), _a = pageIterator_1_1.done, !_a; _d = true) {
						...
						if (shouldStop(page)) return accumulator;
						index += 1;
					}
				} catch (e_1_1) {
					e_1 = { error: e_1_1 };
		...
		*/
		async filesUploadV2(options) {
			...
			(await this.fetchAllUploadURLExternal(fileUploads)).forEach((res, idx) => {
			...
			return {
				ok: true,
				files: await this.completeFileUploads(fileUploads)
			};
		}
		/**
		...
		*/
		async fetchAllUploadURLExternal(fileUploads) {
			return Promise.all(fileUploads.map((upload) => {
				...
				if ("token" in upload) options.token = upload.token;
		...
		async postFileUploadsToExternalURL(fileUploads, options) {
			return Promise.all(fileUploads.map(async (upload) => {
				...
				if (upload_url) {
					const headers = {};
					if (options.token) headers.Authorization = `Bearer ${options.token}`;
					const uploadRes = await this.makeRequest(upload_url, { body }, headers);
					if (uploadRes.status !== 200) return Promise.reject(Error(`Failed to upload file (id:${file_id}, filename: ${filename})`));
					const returnData = {
						ok: true,
						body: uploadRes.data
					};
		...
		*/
		async getAllFileUploads(options) {
			let fileUploads = [];
			if ("file" in options || "content" in options) fileUploads.push(await (0, file_upload_1.getFileUploadJob)(options, this.logger));
			if ("file_uploads" in options) fileUploads = fileUploads.concat(await (0, file_upload_1.getMultipleFileUploadJobs)(options, this.logger));
			return fileUploads;
		}
		/**
		...
		async makeRequest(url, body, headers = {}) {
			const task = () => this.requestQueue.add(async () => {
				try {
					...
					if (url.endsWith("admin.analytics.getFile")) config.responseType = "arraybuffer";
					if (url.endsWith("apps.event.authorizations.list")) body.token = void 0;
					...
					let allHeaders = Object.keys(this.axios.defaults.headers).reduce((acc, cur) => {
						if (!axiosHeaderPropsToIgnore.includes(cur)) acc[cur] = this.axios.defaults.headers[cur];
						return acc;
					}, {});
					...
					if (response.status === 429) {
						...
						if (retrySec !== void 0) {
							...
							if (this.rejectRateLimitedCalls) throw new p_retry_1.AbortError((0, errors_1.rateLimitedErrorWithDelay)(retrySec));
						...
						throw new p_retry_1.AbortError(/* @__PURE__ */ new Error(`Retry header did not contain a valid timeout (url: ${url}, retry-after header: ${response.headers["retry-after"]})`));
					}
					if (response.status !== 200) throw (0, errors_1.httpErrorFromResponse)(response);
					return response;
				} catch (error) {
					const e = error;
					this.logger.warn("http request failed", e.message);
					if (e.request) throw (0, errors_1.requestErrorWithOriginal)(e, this.attachOriginalToWebAPIRequestError);
					throw error;
				}
			});
		...
		*/
		deriveRequestUrl(url) {
			if ((url.startsWith("https://") || url.startsWith("http://")) && this.allowAbsoluteUrls) return url;
		...
		*/
		serializeApiCallData(config) {
			...
			const flattened = Object.entries(data).map(([key, value]) => {
				...
				if (Buffer.isBuffer(value) || (0, is_stream_1.default)(value)) containsBinaryData = true;
				else if (typeof value !== "string" && typeof value !== "number" && typeof value !== "boolean") serializedValue = JSON.stringify(value);
				...
				const form = flattened.reduce((frm, [key, value]) => {
					if (Buffer.isBuffer(value) || (0, is_stream_1.default)(value)) {
						...
						opts.filename = (() => {
							...
							if (typeof streamOrBuffer.name === "string") return (0, node_path_1.basename)(streamOrBuffer.name);
							if (typeof streamOrBuffer.path === "string") return (0, node_path_1.basename)(streamOrBuffer.path);
							return defaultFilename;
						})();
						frm.append(key, value, opts);
					} else if (key !== void 0 && value !== void 0) frm.append(key, value);
					return frm;
				}, new form_data_1.default());
				if (headers) for (const [header, value] of Object.entries(form.getHeaders())) headers[header] = value;
				config.data = form;
			...
			config.data = (0, node_querystring_1.stringify)(flattened.reduce((accumulator, [key, value]) => {
				if (key !== void 0 && value !== void 0) accumulator[key] = value;
				return accumulator;
			}, {}));
			config.headers = headers;
			return config;
		...
		async buildResult(response) {
			...
			if (isGzipResponse) try {
				...
				if (Array.isArray(unzippedData)) {
					for (const dataset of unzippedData) if (dataset && dataset.length > 0) fileData.push(JSON.parse(dataset));
				}
			...
			else if (!isGzipResponse && response.request.path === "/api/admin.analytics.getFile") data = JSON.parse(new node_util_1.TextDecoder().decode(data));
			...
			if (data.response_metadata === void 0) data.response_metadata = {};
			if (response.headers["x-oauth-scopes"] !== void 0) data.response_metadata.scopes = response.headers["x-oauth-scopes"].trim().split(/\s*,\s*/);
			if (response.headers["x-accepted-oauth-scopes"] !== void 0) data.response_metadata.acceptedScopes = response.headers["x-accepted-oauth-scopes"].trim().split(/\s*,\s*/);
			const retrySec = parseRetryHeaders(response);
			if (retrySec !== void 0) data.response_metadata.retryAfter = retrySec;
			return data;
		}
	};
	...
	*/
	function paginationOptionsForNextPage(previousResult, pageSize) {
		if (previousResult !== void 0 && previousResult.response_metadata !== void 0 && previousResult.response_metadata.next_cursor !== void 0 && previousResult.response_metadata.next_cursor !== "") return {
			limit: pageSize,
	...
	*/
	function warnDeprecations(method, logger) {
		if ([
			...
			return new RegExp(`^${depMethod}`).test(method);
	...
	*/
	function warnIfFallbackIsMissing(method, logger, options) {
		...
		if (isTargetMethod && typeof options === "object") {
			...
			} else if (isEmptyText(options)) logger.warn(buildMissingTextWarning());
		}
	}
	/**
	...
	*/
	function warnIfThreadTsIsNotString(method, logger, options) {
		if ([
			...
			"chat.scheduleMessage",
			"files.upload"
		].includes(method) && (options === null || options === void 0 ? void 0 : options.thread_ts) !== void 0 && typeof (options === null || options === void 0 ? void 0 : options.thread_ts) !== "string") logger.warn(buildThreadTsWarningMessage(method));
	}
	...
	*/
	function redact(body) {
		return Object.entries(body).map(([key, value]) => {
			if (value === void 0 || value === null) return [];
			let serializedValue = value;
			if (key.match(/.*token.*/) !== null || key.match(/[Aa]uthorization/)) serializedValue = "[[REDACTED]]";
			if (Buffer.isBuffer(value) || (0, is_stream_1.default)(value)) serializedValue = "[[BINARY VALUE OMITTED]]";
			else if (typeof value !== "string" && typeof value !== "number" && typeof value !== "boolean") serializedValue = JSON.stringify(value);
			return [key, serializedValue];
...
//#endregion
//#region ../../node_modules/.pnpm/@slack+web-api@7.15.0/node_modules/@slack/web-api/dist/index.js
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "ChatStreamer", {
		enumerable: true,
		get: function() {
...
//#endregion
export { require_src as n, require_ms as r, require_dist as t };
