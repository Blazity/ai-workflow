/** Built-in agent prompt templates. Keep these bodies byte-identical unless a
 *  matching prompt-library resync migration is explicitly part of the change. */

export const DEFAULT_RESEARCH_PLAN_PROMPT = `# Instructions
