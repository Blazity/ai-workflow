...
CREATE INDEX "memory_events_forgotten_idx" ON "memory_events" USING btree ("subject","text_hash","at") WHERE "memory_events"."event" = 'removed' and "memory_events"."reason" = 'forgotten';--> statement-breakpoint
...
CREATE UNIQUE INDEX "memory_events_dedupe_unique" ON "memory_events" USING btree ((coalesce("run_id", "actor")),"dedupe_key") WHERE "memory_events"."dedupe_key" is not null;--> statement-breakpoint
