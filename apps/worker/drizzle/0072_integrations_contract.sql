CREATE TABLE IF NOT EXISTS "integration_connection_versions" (
...
ALTER TABLE "workflow_owned_branches" DROP CONSTRAINT IF EXISTS "workflow_owned_branches_provider_check";--> statement-breakpoint
ALTER TABLE "workflow_runs" ADD COLUMN IF NOT EXISTS "status_reason_code" text;--> statement-breakpoint
ALTER TABLE "workflow_runs" ADD COLUMN IF NOT EXISTS "integration_pins" jsonb;--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "integration_connection_versions_unique" ON "integration_connection_versions" USING btree ("integration_id","version");