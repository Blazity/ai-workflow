  ...
  "work_scope.get": {
    ...
    inputSchema: z
      .object({
        ...
        roundsLimit: z.number().int().min(1).max(BRIEFING_PAGE_MAX_BYTES).optional(),
      })
      .strict(),
  ...
  "runs.briefing": {
    ...
    inputSchema: z
      .object({
        ...
        limit: z.number().int().min(1).max(BRIEFING_PAGE_MAX_BYTES).optional(),
      })
      .strict(),
