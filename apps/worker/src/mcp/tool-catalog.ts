...
export const MCP_TOOL_CATALOG = {
  ...
  "repositories.upsert": {
    description:
      "Relationships take `kind` from the fixed vocabulary calls, depends_on, backend_for, frontend_for, deploys, tests, documents, shares_schema_with, mirror_of, related_to, plus an optional `note`; `label` is no longer accepted. " +
