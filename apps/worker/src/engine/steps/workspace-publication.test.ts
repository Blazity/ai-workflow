...
vi.mock("./trusted-workspace-publisher.js", async (importOriginal) => ({
  ...(await importOriginal<typeof import("./trusted-workspace-publisher.js")>()),
  publishTrustedWorkspaceFromSandbox: mocks.publish,
}));
vi.mock("./write-human-decisions-memory.js", () => ({
