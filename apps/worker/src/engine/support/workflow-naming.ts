...
/** Stable names shared by workflow execution and dispatch services. */
export const BRANCH_PREFIX = "ai-workflow/";
export const LEGACY_BRANCH_PREFIX = "blazebot/";

// The gate's check names are the SDK's, because every VCS integration drops
// our own failed checks by the same rule this file names them with.
export { GATE_CHECK_NAME_PREFIX, LEGACY_GATE_CHECK_NAME_PREFIX, isManagedGateCheckName };
