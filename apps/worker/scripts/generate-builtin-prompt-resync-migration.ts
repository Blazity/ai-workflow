 ...
 * text. The drift alarms go red when a new resync migration is needed:
 * src/prompt-library/builtin-prompt-drift.test.ts (every version an active
 * definition actually pins) and `pnpm run check:prompt-drift`.
 *
 ...
 *   pnpm run db:prompt-resync drizzle/<generated file>.sql
 *
