...
function DropTarget({
  ...
  return (
    <div
      ...
      aria-hidden="true"
    >
      <div className={`absolute inset-x-1 top-1/2 h-0.5 -translate-y-1/2 rounded-full bg-mariner transition-opacity duration-[var(--motion-fast)] ${active ? "opacity-100" : "opacity-0"}`} />
    </div>
  );
}
