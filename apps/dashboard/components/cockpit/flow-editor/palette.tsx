            ...
            {grp.items.map((it) => {
              ...
              return (
                <Button
                  ...
                  className="appearance-none text-left mx-2 my-px h-auto py-2 px-2 border border-neutral-200 rounded-[3px] flex items-start gap-2 cursor-grab active:cursor-grabbing bg-panel transition-colors duration-[var(--motion-fast)] disabled:cursor-not-allowed disabled:opacity-55 [&>span]:w-full"
                >
                  <span
          ...
          {grp.items.map((it) => {
            ...
            return (
              <Button
                ...
                className="appearance-none h-auto w-full text-left border-none cursor-pointer flex items-start gap-3 px-[18px] py-3 bg-transparent active:bg-app-bg disabled:cursor-not-allowed disabled:opacity-55 [&>span]:w-full"
              >
                <span
